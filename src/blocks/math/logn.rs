...
/// Outputs the natural logarithm value of the input.
#[block]
...
mod test {
    ...
    use crate::{
        base::block::test_utils::write_block_inputs, base::block::Block, blocks::math::Logn,
    };
    ...
    async fn test_logn_block() {
        ...
        assert_matches!(
            block.out.value,
            Value::Number(Number { value, .. }) if value == 1.0
        );
    }
}
